...
class Map extends Component {
    ...
    render() {
        ...
        return (
            <div>
            <div>    
                 <h3>Graph using a force layout: Cluster {this.state.cluster}</h3>
                    <svg ref={node => this.node = node}
                width={this.state.width} height={this.state.height}>
                </svg>
                </div>
                <button className="c1" onClick={this.swtichCluster.bind(this,1)}>Cluster 1</button>
                <button className="c2" onClick={this.swtichCluster.bind(this,2)}>Cluster 2</button>
